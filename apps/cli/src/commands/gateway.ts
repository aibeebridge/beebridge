...
import { assertGatewayDistExists } from "../build-preflight.js";
...
export async function startGatewayUi(options: {
  port?: string;
  daemon?: boolean;
  dev?: boolean;
}): Promise<void> {
  ...
  const npmScript = dev ? "dev:gateway" : "start:gateway";
...
export async function restartGatewayUi(options: {
  port?: string;
  daemon?: boolean;
  dev?: boolean;
}): Promise<void> {
